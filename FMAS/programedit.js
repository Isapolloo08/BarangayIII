...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, Dimensions, Alert, Image, ScrollView } from 'react-native';
...
export default function EditProgram({ route, navigation }) {
  ...
  const handleEditProgram = () => {
    ...
    // Example: save or update program details
    // e.g., updateProgram({
    //   id: program.id, // Only required if editing an existing program
    //   name: programName,
    //   aipReferenceCode,
    //   accountCode,
